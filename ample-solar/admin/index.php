    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($result) {
          ...
          if($totalrows == 1) { 
            ...
            echo '<script language="javascript" type="text/javascript">window.location = "inquiry-responses.php"</script>';
          }
          else {
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4 font-weight-bold">Ample Solar</h1>
                                    </div>
