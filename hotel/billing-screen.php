<?php
  ...
  $bill_id_sql = "SELECT MAX(`bill_id`) AS last_bill_id FROM `tbl_bills`";

  $bill_id_result = mysqli_query($conn, $bill_id_sql);

  while ($bill_id_data = mysqli_fetch_assoc($bill_id_result)) {
      $bill_id = $bill_id_data['last_bill_id'] + 1;
  }
                            ...
                            <form name="myform" id="myform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" onsubmit ="return validate()" autocomplete="off">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="total_person" name="total_person" placeholder="Total Person">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row mx-1">
                                    ...
                                    <div class="col-md-10 border">
                                        ...
                                        <div class="table-responsive table-wrapper" id="tab">
                                ...
                                <div class="row mx-1">
                                    ...
                                    <div class="col-md-6 row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control ml-2  col-md-3" type="number" step="any" id="discount_value" name="discount_value" required="" value="0">
                                                <input class="form-control ml-2  col-md-3" type="number" step="any" id="discount_value1" name="discount_value1" required="" value="0" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row p-2 pt-4">
                                            ...
                                            <div class="m-1">
                                                <input type="button" id="print_bill" name="print_bill" class="btn btn-success btn-pdf" value="Print Bill">
                                            </div>
                                            <div class="m-1">
    ...
    <script type="text/javascript">
        $(".btn-pdf").click(function(){ 
            ...
            function createPDF() {
                ...
                var bill_details = "Bill No:" + bill_id + "&emsp;";

                var table_no = $('#table_no').val();
                var table_details = "Table No:" + table_no + "&emsp;";

                var total_person = $('#total_person').val();
                var person_details = "Total Person:" + total_person + "&emsp;";

                var cust_name = $('#cust_name').val();
                var cust_details = "Customer Name:" + cust_name + "&emsp;";
                ...
                win.document.write("<h4 class='col-md-6'>" + bill_details + "</h4>");
                win.document.write("<h4 class='col-md-6'>" + table_details + "</h4>");
                win.document.write("<h4 class='col-md-6'>" + person_details + "</h4>");
