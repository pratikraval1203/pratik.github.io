                ...
                <div class="card shadow mb-4">
                    <?php 
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Bill Wise Report</h6>
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php
                                    if (isset($_POST['date_submit'])) {
                                        ...
                                        $select_sql = "SELECT * FROM `tbl_bills` WHERE `bill_status` = 1 && `bill_date` BETWEEN '$start_date' AND '$end_date' ORDER BY `bill_id` DESC";
