<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $update_sql = "UPDATE `tbl_admin` SET `email`='$email',`username`='$username',`password`='$password',`admin_mobile`='$admin_mobile',`user_role`='$user_role',`updated_time`='$updated_time',`updated_by`='$updated_by' WHERE `admin_id`='$admin_id'";
