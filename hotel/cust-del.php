<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `customer_master` WHERE `cust_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Customer successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'cust-master.php?msg=".$alert."'</script>";
		} 
