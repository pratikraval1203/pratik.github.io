<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $insert_sql = "INSERT INTO `item_master`(`item_code`, `item_name`, `item_unit`, `item_rate_1`, `item_rate_2`, `item_rate_3`, `item_rate_4`, `item_rate_5`, `item_rate_6`, `department_name`, `item_type`, `updated_time`, `updated_by`) VALUES ('$item_code','$item_name','$item_unit','$item_rate_1','$item_rate_2','$item_rate_3','$item_rate_4','$item_rate_5','$item_rate_6','$department_name','$item_type','$updated_time', '$updated_by')";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add New Item</h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="item_unit" name="item_unit" placeholder="Item Unit" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control mydrpdwn" name="department_name" id="department_name" placeholder="Select Department" required="">
                                                <!-- <?php 
                                                  ...
                                                  $sql = "SELECT `department_id`,`department_name` FROM `department_master` WHERE `department_id` = '$department_id'";
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="item_rate_1" name="item_rate_1" placeholder="Item Rate 1">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="item_rate_2">Item Rate 2 (Non AC)</label>
                                            <input type="number" class="form-control" id="item_rate_2" name="item_rate_2" placeholder="Item Rate 2">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">    
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="item_rate_3" name="item_rate_3" placeholder="Item Rate 3">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="item_rate_4">Item Rate 4 (Banquet)</label>
                                            <input type="number" class="form-control" id="item_rate_4" name="item_rate_4" placeholder="Item Rate 4">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="item_rate_5" name="item_rate_5" placeholder="Item Rate 5">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="item_rate_6">Item Rate 6 (Zomato)</label>
                                            <input type="number" class="form-control" id="item_rate_6" name="item_rate_6" placeholder="Item Rate 6">
                                        </div>
                                    </div>
                                </div> 
                                <input type="submit" name="submit" class="btn btn-primary pull-left" value="Add Item">
