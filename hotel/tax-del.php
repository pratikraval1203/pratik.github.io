<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `tax_master` WHERE `tax_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Tax successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'tax-master.php?msg=".$alert."'</script>";
		} 
