<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `department_master` WHERE `department_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Department successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'department-master.php?msg=".$alert."'</script>";
		} 
