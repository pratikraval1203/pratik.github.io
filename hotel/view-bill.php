...
<body id="page-top" onload="load_body()">
                                    ...
                                    <div class="col-md-4">
                                            <div class="row p-2 pt-4">
                                                <!-- <div class="col-md-1 mr-5">
                                                    <input type="submit" id="submit" name="submit" class="btn btn-primary" value="Save Edited Bill">
                                                </div> -->
                                                <!-- <div class="col-md-1">
                                               ...
                                               <!--  <div class="col-md-1">
                                                ...
                                                <?php
                                                    $link = "edit-saved-bills.php?edit_id=".$bill_id;
                                                ?>
                                                <div class="m-1">
                                                    <a class="btn btn-info" href="<?php echo $link; ?>">Edit Bill</a>
                                                </div>
                                                <div class="m-1">
    ...
    <script type="text/javascript">
        ...
        //                             }
        //                         });
        //                         window.location.href = "bill-master.php";
        //                     } else {
        //                         window.location.replace("bill-master.php");
        //                     }
        //                 }
