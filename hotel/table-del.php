<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `new_table_master` WHERE `table_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Table successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'table-master.php?msg=".$alert."'</script>";
		} 
