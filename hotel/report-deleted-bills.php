                ...
                <div class="card shadow mb-4">
                    <?php 
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Deleted Bills Report</h6>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <form name="myform1" id="myform" class="col-md-8 row" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php
                                    if (isset($_POST['date_submit'])) {
                                        ...
                                        $select_sql = "SELECT * FROM `tbl_bills` WHERE `bill_status` = 3 && `bill_date` BETWEEN '$start_date' AND '$end_date' ORDER BY `bill_id` DESC";
                                        
                                    } else {
                                       $current_date = date('Y-m-d');

                                       $select_sql = "SELECT * FROM `tbl_bills` WHERE `bill_status` = 3 && `bill_date` = '$current_date' ORDER BY `bill_id` DESC";
                                    }
                                    ...
                                    while ($data = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '<tr>';
                                            ...
                                            echo '<td nowrap>';
                                            echo '<a class="btn text-primary delete" data-id="'.$data['bill_id'].'"><i class="far fa-times-circle p-1" aria-hidden="true"></i></a>';
                                            echo '</td>';
                                        echo '</tr>';
                                    }
                                    echo '</tbody>';
            ...
            if (password == og_password) {
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        if (data_success.statusCode == 200) {
                            alert('Bill Erased Sucessfully')
                            window.location = 'report-deleted-bills.php';
                        } else {
                            alert('Error Erasing Bill...');
                        }
                    }
                });  
            } else {
