                ...
                <div class="card shadow mb-4">
                    <?php 
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Settlement Report</h6>
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php
                                    if (isset($_POST['date_submit'])) {
                                        ...
                                        $select_sql = "SELECT * FROM `tbl_bills` WHERE `bill_status` = 1 && `bill_date` = '$end_date'";
                                        
                                    } else {
                                       $current_date = date('Y-m-d');

                                       $select_sql = "SELECT * FROM `tbl_bills` WHERE `bill_status` = 1 && `bill_date` = '$current_date'";
                                    }
                                    ...
                                    echo '<tfoot>';
                                        echo '<tr>';
                                            ...
                                            echo "<th>".$total_credit."</th>";
                                            echo "<th>".$total_customer_account."</th>";
                                            echo "<th nowrap>0</th>";
                                            echo "<th nowrap>0</th>";
                                        echo '</tr>';
                                    echo '</tfoot>';
