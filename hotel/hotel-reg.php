<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $insert_sql = "INSERT INTO `hotel_master`(`hotel_name`, `hotel_mobile`, `hotel_website`, `hotel_reg_no`, `hotel_gst_no`, `hotel_email`, `hotel_address`, `updated_time`, `updated_by`) VALUES ('$hotel_name','$hotel_mobile','$hotel_website','$hotel_reg_no','$hotel_gst_no','$hotel_email','$hotel_address','$updated_time', '$updated_by')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Hotel Register</h1>
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add New Hotel</h6>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hotel_name" name="hotel_name" placeholder="Hotel Name" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="hotel_mobile">Hotel Mobile No.<span class="star">*</span></label>
                                            <input type="number" class="form-control" id="hotel_mobile" name="hotel_mobile" placeholder="Hotel Mobile No." required="">
                                            <span id="numloc"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hotel_website" name="hotel_website" placeholder="Hotel Website">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hotel_reg_no" name="hotel_reg_no" placeholder="Hotel Reg No.">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="hotel_gst_no">Hotel GST No.</label>
                                            <input type="text" class="form-control" id="hotel_gst_no" name="hotel_gst_no" placeholder="Hotel GST No.">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="hotel_address" name="hotel_address" placeholder="Hotel Address">
                                        </div>
                                    </div>
                                </div>
                                <input type="submit" name="submit" class="btn btn-primary pull-left" value="Add Hotel">
