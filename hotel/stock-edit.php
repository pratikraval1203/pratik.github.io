<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $update_sql = "UPDATE `stock_master` SET `stock_company_name`='$stock_company_name',`stock_bill_no`='$stock_bill_no',`stock_date`='$stock_date',`stock_barcode_no`='$stock_barcode_no',`stock_item_type`='$stock_item_type',`stock_item_name`='$stock_item_name',`stock_qty`='$stock_qty',`stock_unit`='$stock_unit',`updated_time`='$updated_time',`updated_by`='$updated_by' WHERE `stock_id`='$stock_id'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Edit Stock Entry</h6>
                      ...
                      ?>
                        <div class="card-body p-3">
                            ...
                            <form name="myform" action="<?php echo $_SERVER['PHP_SELF'].'?edit_id='.$edit_id; ?>" method="POST" onsubmit ="return validate()" autocomplete="off">
                                ...
                                $select_sql = "SELECT * FROM `stock_master` WHERE `stock_id` = '$edit_id'";
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="stock_company_name" name="stock_company_name" placeholder="Company Name" required="" value="<?php echo $data['stock_company_name']; ?>">
                                            <input type="hidden" class="form-control" name="stock_id" value="<?php echo $data['stock_id']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="stock_bill_no">Bill No.<span class="star">*</span></label>
                                            <input type="text" class="form-control" id="stock_bill_no" name="stock_bill_no" placeholder="Bill No." required="" value="<?php echo $data['stock_bill_no']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="stock_date">Bill Date</label>
                                            <input type="date" class="form-control" id="stock_date" name="stock_date" placeholder="Bill Date" value="<?php echo $data['stock_date']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="stock_barcode_no" name="stock_barcode_no" placeholder="Bill Barcode No." value="<?php echo $data['stock_date']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="stock_qty" name="stock_qty" placeholder="Item Qty" value="<?php echo $data['stock_qty']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="stock_unit">Stock Unit</label>
                                            <input type="text" class="form-control" id="stock_unit" name="stock_unit" placeholder="Stock Unit" value="<?php echo $data['stock_unit']; ?>">
                                        </div>
                                    </div>
                                </div>
