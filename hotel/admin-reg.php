<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $insert_sql = "INSERT INTO `tbl_admin`(`email`, `username`, `password`, `admin_mobile`, `user_role`, `updated_time`, `updated_by`) VALUES ('$email','$username','$password','$admin_mobile','$user_role','$updated_time', '$updated_by')";
