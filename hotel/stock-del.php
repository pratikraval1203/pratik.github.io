<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `stock_master` WHERE `stock_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Stock successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'stock-master.php?msg=".$alert."'</script>";
		} 
