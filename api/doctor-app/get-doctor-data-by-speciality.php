<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'GET') {
		...
		if (isset($_GET['speciality'])) {
			...
			$select_sql = "SELECT * FROM `tbl_doctor` LEFT JOIN `tbl_doctor_profile` ON tbl_doctor.doctor_id = tbl_doctor_profile.doctor_id WHERE `speciality` = '$speciality'";
	        ...
	        $double = array(
							'msg' => 'Unable to Get doctor Data By Speciality',
							'statusCode' => 503
							);
