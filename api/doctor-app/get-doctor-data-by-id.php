<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'GET') {
		...
		if (isset($_GET['doctor_id'])) {
			...
			$select_sql = "SELECT * FROM `tbl_doctor` LEFT JOIN `tbl_doctor_profile` ON tbl_doctor.doctor_id = tbl_doctor_profile.doctor_id WHERE tbl_doctor.doctor_id = '$doctor_id'";
	        ...
	        $double = array(
							'msg' => 'Unable to Get doctor Data By ID',
							'statusCode' => 503
							);
