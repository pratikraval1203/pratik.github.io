<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `track_machine_engine_master` WHERE `tmem_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Records successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'tmem-master.php?msg=".$alert."'</script>";
		} 
