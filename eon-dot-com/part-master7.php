...
<head>
    ...
    <title>Part GST Details Entry</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 clearfix">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Part GST Details Entry</h6>
                            <a class="float-right font-weight-bold mylink" href="pm7-reg.php">
                                <i class="fa fa-plus"></i>
                                Add Part  GST Details
                            </a>                 
                        </div>
                        <div class="card-body">
                            <div class="clearfix">
