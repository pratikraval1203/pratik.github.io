                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Part Opening Stock</h6>
                        ...
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $action; ?>" method="post" onsubmit="return validate()">
                            <div class="form-group mb-3 ml-4 mt-3">
                                <!-- <label for="part_sel_id" class="form-label">Select Part:</label> -->
                                <select id="part_sel_id" class="mydrpdwn col-md-3 form-control" name="part_sel_id" required="required">
                                    <?php
                                        $number = "";
                            ...
                            <div class="form-group mb-3 ml-4 clearfix">
                            ...
                            <div class="apsection">
                                ...
                                <div class="form-group mb-3 half" id="show-me-2">
                                ...
                                <!-- <div class="form-group mb-3 half">
                                    <label class="form-label" for="text-input">Storage Location</label>
                                    <input class="form-control" required="required" type="text" id="text-input" name="part_storage_location" list="storage" />
                                    <datalist id="storage">
                                        <?php
                                            $query = "SELECT DISTINCT `part_storage_location` FROM `part_master_three`";
                            ...
                            <div class="row ml-3" id="show-me-3">
                        ...
                        <form id="part_master32" class="bootstrap-form-with-validation" action="<?php $action ?>" method="post">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT part_master_three_ex.part_id, `pm3_id`, `part_op_stock`, `part_storage_location`, part_master_one.part_id, part_master_one.part_desc, part_master_one.part_number FROM `part_master_three_ex` LEFT JOIN `part_master_one` ON part_master_three_ex.part_id = part_master_one.part_id";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><input type='text' name='final_op_stock[]' value='<?= $part_op_stock ?>'></td>
