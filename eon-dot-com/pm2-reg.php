<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($part_min_stock > $part_max_stock) {
            ...
            $insert_sql = "INSERT INTO `part_master_two`(`part_id`, `part_min_stock`, `part_max_stock`, `part_warranty`, `part_updated_time`, `part_updated_by`) VALUES ('$part_sel_id','$part_min_stock','$part_max_stock','$part_warranty','$updated_time','$updated_by')";
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Part Details</h6>
