<?php
    ...
    if (isset($_POST['final_submit'])) {
        ...
        for ($i= 0 ; $i < $count1 ; $i++) {
            $final_sql = "INSERT INTO `track_machine_master_two`(`tm_id`,`tm_catagory`, `part_id`, `tm_part_desc`, `first_poh_qty`, `first_mc`, `second_poh_qty`, `second_mc`, `third_poh_qty`, `third_mc`, `updated_time`, `updated_by`) VALUES ('{$final_tm_sel_id[$i]}','{$final_tm_catagory[$i]}','{$final_part_id[$i]}','{$final_part_desc[$i]}','{$final_first_poh_qty[$i]}','{$final_first_mc[$i]}','{$final_second_poh_qty[$i]}','{$final_second_mc[$i]}','{$final_third_poh_qty[$i]}','{$final_third_mc[$i]}','$updated_time','$updated_by')";
    ...
    elseif (isset($_POST['submit'])) {    
        ...
        $sql = "INSERT INTO `track_machine_master_two_ex`(`tm_id`,`tm_catagory`, `part_id`, `tm_part_desc`, `first_poh_qty`, `first_mc`, `second_poh_qty`, `second_mc`, `third_poh_qty`, `third_mc`, `updated_time`, `updated_by`) VALUES ('$tm_sel_id','$tm_catagory','$part_sel_id','$part_desc','$first_poh_qty','$first_mc','$second_poh_qty','$second_mc','$third_poh_qty','$third_mc','$updated_time','$updated_by')";
...
<head>
    ...
    <title>Add Track Machine Details</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Track Machine Details</h6>
                        ...
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validate()">
                            ...
                            <div class="row mt-3 mx-3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <!-- <span class="red"></span> -->
                                    <input id="part_desc" class="form-control" type="text" name="part_desc" required="required">
                                </div>
                                <div class="form-group col-md-4">
                    ...
                    <div class="card mb-4 shadow">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Added Track Machine Details</h6>
                        ...
                        <form id="part_master32" class="bootstrap-form-with-validation" action="<?php $action ?>" method="post">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT track_machine_master_two_ex.part_id, `tm2_id`, `tm_id`, `tm_part_desc`, `tm_catagory`,`first_poh_qty`, `first_mc`, `second_poh_qty`, `second_mc`, `third_poh_qty`, `third_mc`, part_master_one.part_id, part_master_one.part_desc FROM `track_machine_master_two_ex` LEFT JOIN `part_master_one` ON track_machine_master_two_ex.part_id = part_master_one.part_id ORDER BY `tm2_id` DESC";
                                    ...
                                    ?>
                                        <tr>
                                            <!-- <td><?= $count ?></td> -->
                                            <?php
                                                $tmsql = "SELECT `tm_model_no` FROM `track_machine_master_one` WHERE `tm_id` = '$tm_id'";

                                                $tmresult = mysqli_query($conn,$tmsql);

                                                while($tmrow = mysqli_fetch_array($tmresult) ){
                                                    $tm_model_no = $tmrow['tm_model_no'];
                                            ?>
                                            <td>
                                                <input type='text' name='final_tm_model_no[]' value='<?= $tm_model_no ?>' readonly>
