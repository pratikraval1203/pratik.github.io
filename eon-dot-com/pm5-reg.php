    ...
    if (isset($_POST['submit'])) {
        ...
        if ($image_alert != "") {
            ...
            if ($video_alert != "") {
                ...
                $insert_sql = "INSERT INTO `part_master_five`(`part_id`, `part_ann_entry_no`, `part_spn`, `part_drawing_no`, `part_proposed_by`, `part_pic_link`, `part_video_link`, `part_updated_time`, `part_updated_by`) VALUES ('$part_sel_id','$part_ann_entry_no','$part_spn','$part_drawing_no','$part_proposed_by','$part_pic_link','$part_video_link','$updated_time','')";
...
<head>
    ...
    <title>Add Part Annexure Details</title>
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Part Annexure Details</h6>
                        ...
                        <form name="myform" enctype="multipart/form-data" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validate()">
                            <div class="row mt-3 mx-3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" type="text" id="text-input" name="part_spn">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="form-label" for="text-input">Drawing No.(Not Mendatory)</label>
                                    <input class="form-control"(Not Mendatory)(Not Mendatory) type="text" id="text-input" name="part_drawing_no">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="part_proposed_by">Proposed By(Not Mendatory)(Not Mendatory)</label>
