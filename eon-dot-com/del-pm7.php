<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `part_master_seven` WHERE `part_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Record successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'part-master7.php?msg=".$alert."'</script>";
		} 
