<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_sql = "INSERT INTO `user_master`(`usr_name`, `usr_password`, `usr_department`, `usr_designation`, `usr_email`, `usr_mobile`, `usr_is_active`, `usr_admin_level`, `usr_remarks`, `usr_updated_time`, `usr_updated_by`) VALUES ('$name','$pass','$dept','$designation','$email','$mobile','$is_active','$usr_admin_level','$usr_remarks','$updated_time',$updated_by)";
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add New User </h6>
                      ...
                      ?>
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validate()" autocomplete="off">
                            <div class="row mt-3 mx-3">                           
                                <div class="form-group col-md-4">   
                                    <label class="form-label" for="text-input">Username</label>
                                    <input class="form-control" type="text" id="text-input" name="usr_name" required="required" autocomplete="off">
                                    <span id="nameloc"></span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="form-label" for="password-input">Password</label>
                                    <input class="form-control" type="password" id="password-input" name="usr_password" required="required">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="form-label" for="email-input">Email</label>
                                    <input class="form-control" type="email" id="email-input" name="usr_email" required="required">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="form-label" for="text-input">Mobile Number</label>
                                    <input class="form-control" type="text" id="text-input-1" name="usr_mobile" required="required">
                                    <span id="numloc"></span>
                                </div>
                                <div class="form-group mb-3 col-md-4">
                                    ...
                                    ?>
                                        <input id="usr_dept" name="usr_dept" class="form-control mydrpdwn" required="required" type="text" list="department" />
                                ...
                                <div class="form-group mb-3 col-md-4">
                                    ...
                                    <?php
                                        if ($_SESSION['admin_level'] == 1 || $_SESSION['admin_level'] == 2) {
                                    ?>
                                        <input id="usr_designation" name="usr_designation" class="form-control mydrpdwn" required="required" type="text" list="designation" />
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" type="text" id="remarks" name="usr_remarks">
                                    <!-- <span id="numloc"></span> -->
                                </div>
                                ...
                                <!-- <div class="form-group mb-3 ml-3 clearfix">
                                    ...
                                    <div class="form-check float-left ml-2">
                                        <input class="form-check-input" type="radio" name="is_admin" id="formCheck-2" value="1">
                                        <label class="form-check-label" for="formCheck-2">Yes</label>
                                    </div>
                                    <div class="form-check float-left ml-2">
                                        <input class="form-check-input" type="radio" name="is_admin" id="formCheck-3" value="0" checked="">
                                        <label class="form-check-label" for="formCheck-3">No</label>
                                    </div>
                                </div> -->
