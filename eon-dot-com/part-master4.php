...
<head>
    ...
    <title>Repairable Part Entry</title>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 clearfix">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Repairable Part Entry</h6>
                            <a class="float-right font-weight-bold mylink" href="pm4-reg.php">
