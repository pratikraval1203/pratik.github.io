<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `track_machine_schedule_entry` WHERE `tmse_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Records successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'schedule-entry.php?msg=".$alert."'</script>";
		} 
