<?php
    ...
    if (isset($_POST['submit'])) {    
        ...
        $sql = "INSERT INTO `track_machine_schedule_entry` (`tmse_tm_id`, `tmse_unique_machine_no`, `tmse_purchase_date`, `tmse_rlway_with`, `tmse_division_with`, `tmse_first_poh`, `tmse_second_poh`, `tmse_third_poh`, `tmse_other_work`, `tmse_tdd_1st_poh`, `tmse_tdd_2nd_poh`, `tmse_tdd_3rd_poh`, `updated_time`, `updated_by`) VALUES ('$tm_sel_id','$tmse_unique_machine_no','$tmse_purchase_date','$tmse_rlway_with','$tmse_division_with','$tmse_first_poh','$tmse_second_poh','$tmse_third_poh','$tmse_other_work','$tmse_tdd_1st_poh','$tmse_tdd_2nd_poh','$tmse_tdd_3rd_poh','$updated_time','$updated_by')";
...
<head>
    ...
    <title>Add Schedule Entry Details</title>
...
<body id="page-top">
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Schedule Entry Details</h6>
                        ...
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validate()">
                            ...
                            <div class="row mt-3 mx-3">
                                <div class="form-group col-md-3">
                                    ...
                                    <!-- <span class="red"></span> -->
                                    <input id="tmse_unique_machine_no" class="form-control" type="text" name="tmse_unique_machine_no" required="required">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_purchase_date">Date of Purchase</label>
                                    <!-- <input class="form-control mydrpdwn" required="required" type="date" id="tmse_purchase_date" name="tmse_purchase_date"> -->
                                    <input type="text" pattern="\d{1,2}/\d{1,2}/\d{4}" id="datepicker" name="date" value=""  placeholder="dd-mm-yyyy" />
                                    <!-- <input type="date" name=""> -->
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_rlway_with">Rlway With</label>
                                    <input class="form-control" required="required" type="text" id="tmse_rlway_with" name="tmse_rlway_with" list="rlway" />
                                    <datalist id="rlway">
                                        <?php
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" required="required" type="text" id="tmse_division_with" name="tmse_division_with" list="division" />
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_first_poh" name="tmse_first_poh">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_second_poh">2nd POH Date</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_second_poh" name="tmse_second_poh">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_third_poh">3rd POH Date</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_third_poh" name="tmse_third_poh">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_other_work">Other Work</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_other_work" name="tmse_other_work">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_tdd_1st_poh">Tentative Date of Departure from CPOH ADI  AFTER 1ST POH</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_tdd_1st_poh" name="tmse_tdd_1st_poh">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_tdd_2nd_poh">Tentative Date of Departure from CPOH ADI  AFTER 2nd POH</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_tdd_2nd_poh" name="tmse_tdd_2nd_poh">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="form-label" for="tmse_tdd_3rd_poh">Tentative Date of Departure from CPOH ADI  AFTER 3rd POH</label>
                                    <input class="form-control mydrpdwn" required="required" type="date" id="tmse_tdd_3rd_poh" name="tmse_tdd_3rd_poh">
                                </div>
                            </div>
    ...
    $('input[type="date"]').change(function(){
        // myform.getElementById['tmse_tdd_2nd_poh'].value= this.value.split("-").reverse().join("-");
