<?php
    ...
    if (isset($_POST['submit'])) {    
        ...
        $sql = "UPDATE `track_machine_engine_master` SET `tmem_brand`='$tmem_brand',`tmem_model_no`='$tmem_model_no',`tmem_remarks`='$tmem_remarks',`updated_time`='$updated_time',`updated_by`='$updated_by' WHERE `tmem_id`='$tmem_id'";
...
<head>
    ...
    <title>Edit Track Machine Engine Details</title>
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Edit Track Machine Engine Details</h6>
                        ...
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF'].'?edit_id='.$edit_id; ?>" method="post" onsubmit="return validate()">
                            <?php
                                $select_sql = "SELECT * FROM `track_machine_engine_master` WHERE `tmem_id` = '$edit_id'";
                            ...
                            <div class="row mt-3 mx-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="tmem_brand" list="brand" name="tmem_brand"  required="" class="form-control" value="<?php echo $data['tmem_brand']; ?>" />
                                    <datalist id="brand">
                                        <?php
                                    ...
                                    <input type="hidden" name="tmem_id" value="<?php echo $data['tmem_id']; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="tmem_model_no">Model No.</label>
                                    <input type="text" id="tmem_model_no" name="tmem_model_no" class="form-control" required="" value="<?php echo $data['tmem_model_no'] ?>">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="tmem_remarks">Remarks(Not Mendatory)</label>
                                    <!-- <span class="red"></span> -->
                                    <input id="tmem_remarks" class="form-control" type="text" name="tmem_remarks" value="<?php echo $data['tmem_remarks']; ?>">
                                </div>          
                            </div>
