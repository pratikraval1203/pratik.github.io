<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        // }
        // else {
            $insert_sql = "UPDATE `part_master_seven` SET `part_hsn`='$part_hsn',`part_gst`='$part_gst',`part_updated_time`='$updated_time',`part_updated_by`='$updated_by' WHERE `part_id`='$part_sel_id'";
...
<head>
    ...
    <title>Edit Part GST Details</title>
                ...
                <div class="container-fluid">
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        ...
                        <?php
                            $select_sql = "SELECT part_master_seven.part_id, `part_hsn`, `part_gst`, part_master_one.part_id, part_master_one.part_desc FROM `part_master_seven` LEFT JOIN `part_master_one` ON part_master_seven.part_id = part_master_one.part_id WHERE part_master_seven.part_id = '$edit_id'";
                        ...
                        ?>
                            <div class="row mt-3 mx-3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" required="required" type="text" id="text-input" name="part_hsn" list="hsn" value="<?php echo $data['part_hsn']; ?>" />
                                    <datalist id="hsn">
                                        <?php
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" required="required" type="number" id="text-input" name="part_gst" step="any" list="gst" value="<?php echo $data['part_gst']; ?>"  />
                                    <datalist id="gst">
                                        <?php
