                        ...
                        <form name="myform" class="bootstrap-form-with-validation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validate()">
                            ...
                            <div class="row mt-3 mx-3">
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <!-- <span class="red"></span> -->
                                    <input class="form-control" type="text" name="cp_address" required="required">
                                </div>
                            </div>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                ...
                                                <input type='hidden' name='final_cp_dept[]>' value='<?= $cp_dept ?>' readonly>
                                                <input type='hidden' name='final_cp_designation[]>' value='<?= $cp_designation ?>' readonly>
                                                <input type='hidden' name='final_cp_email[]>' value='<?= $cp_email ?>' readonly>
                                                <input type='hidden' name='final_cp_address[]>' value='<?= $cp_address ?>' readonly>
                                                <input type='text' name='final_ven_name[]>' value='<?= $ven_name ?>' readonly>
                                            </td>
                                            <td><input type='text' name='final_cp_name[]' value='<?= $cp_name ?>' readonly></td>
                                            <td><input type='text' name='final_cp_mobile[]' value='<?= $cp_mobile ?>' readonly></td>
