<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `track_machine_master_one` WHERE `tm_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "Track Machine successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'track-machine-master1.php?msg=".$alert."'</script>";
		} 
