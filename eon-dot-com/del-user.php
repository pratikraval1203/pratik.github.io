<?php
	if (isset($_GET['delete_id'])) {
		...
		$sql = "DELETE FROM `user_master` WHERE `usr_id` = '$delete_id'";

		if(mysqli_query($conn , $sql)) {
		 	$alert = "User successfully deleted";
  		     echo "<script language='javascript' type='text/javascript'>window.location = 'user-master.php?msg=".$alert."'</script>";
		} 
