...
<head>
    ...
    <title>Add Part Brand Details</title>
                    ...
                    <div class="card mb-4 shadow">
                      ...
                      ?>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold float-left text-primary">Add Part Brand Details</h6>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><input type='text' name='final_part_amb[]' value='<?= $part_amb ?>'>
                                            </td>
                                            <td>
                                                <?php
